...
public class DataProvider {
    ...
    private static List<Kuda> initDataKuda(Context ctx) {
        ...
        kudas.add(new Kuda("kuda arab", "arab",
                "Kuda arab adalah salah satu jenis kuda yang berasal dari daerah arab, dipelihara orang untuk berbagai keperluan", R.drawable.arab));
        kudas.add(new Kuda("Kuda Amerikan Quarter ", "Amerika serikat ",
                "Kuda Amerikan Quarteratau Quarter Horse adalah jenis kuda amerika yang unggul dalam berlari jarak pendek", R.drawable.quater));
        kudas.add(new Kuda("Kuda Appalosa", "Amerika serikat ",
                "Kuda Appalosa adalah jenis kuda amerika yang terkenal karena pola mantelnya yang penuh warna ", R.drawable.appaloosa));
        kudas.add(new Kuda("Kuda Clydesdale", "Skotlandia",
                "merupakan salah satu jenis kuda yang berasal dari skotlandia, Clydesdale bermula dipertengan abad ke-18 didaerah Clyde.", R.drawable.clydesdale));
        kudas.add(new Kuda("Kuda Frisian", "Friesland,Belanda",
                "Adalah jenis kuda yang berasal dari Friesland, dibelanda", R.drawable.frisian));
        kudas.add(new Kuda("Kuda SHire", "Inggris",
                "adalah jenis kuda rancangan inggris. Biasanya hitam,teluk atau abu-abu ", R.drawable.shire));
        return kudas;
    }
